...
%            nth epoch. If the epoch size is even IX_CENTER correspond to
%            the (size_epoch/2) -th element of the epoch. If it's odd, 
%            IX_CENTER is the ceil(size_epoch/2) -th element
% 
%
%
% e.g 
...
epochs = zeros(size_epoch,n_channels,n_epochs, data_class);
