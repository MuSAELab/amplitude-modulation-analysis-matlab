function psd_struct = rfft_psd(x, fs, n_fft, win_funct, channel_names)
...
psd_struct.PSD = psd;
psd_struct.fs = fs;
psd_struct.freq_axis = f_ax;
psd_struct.freq_delta = f_delta;
psd_struct.n_samples = n_samples;
psd_struct.n_fft = n_fft;
psd_struct.win_funct = win_funct;
psd_struct.channel_names = channel_names;
